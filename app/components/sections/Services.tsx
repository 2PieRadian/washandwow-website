...
export default function Services() {
  return (
    <section className="py-[60px] sm:py-[80px] md:py-[120px] relative px-[15px] sm:px-[20px]">
      <ServicesSvg />
