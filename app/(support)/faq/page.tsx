...
function FaqItem({
  ...
  return (
    <div className="border-l-2 border-[#E8DFD6] pl-4 sm:pl-5">
        ...
        <div className="mx-auto max-w-5xl space-y-10">
          <FaqCategory emoji="🧺" title="General Questions">
            <FaqItem n={1} question="What is Wash & Wow?">
              <p>
                Wash &amp; Wow is a doorstep laundry and dry-cleaning service
                that allows you to schedule pickup and delivery through our
                mobile application.
              </p>
            </FaqItem>
            ...
            >
              <p>
                Yes. All orders are managed through our mobile application to
                ensure smooth tracking, updates, and service management.
              </p>
            </FaqItem>
          </FaqCategory>
          ...
          <FaqCategory emoji="📦" title="Pickup & Delivery">
            ...
            >
              <p>
                ...
                rescheduled. We recommend being available or assigning someone
                to hand over the clothes.
              </p>
            </FaqItem>
          ...
          <FaqCategory emoji="💰" title="Pricing & Payments">
            <FaqItem n={7} question="How is pricing calculated?">
              <p>
                Prices are shown in the app based on the service selected. Final
                pricing may vary after inspection of garments.
              </p>
            </FaqItem>
            <FaqItem n={8} question="What payment methods do you accept?">
              <p>
                We support secure online payments through trusted payment
                gateways. Available options may include UPI, debit/credit cards,
                and wallets.
              </p>
            </FaqItem>
            <FaqItem n={9} question="Are there any hidden charges?">
              <p>
                No. We aim for transparent pricing. Any changes due to garment
                condition will be communicated before processing.
              </p>
            </FaqItem>
          </FaqCategory>
          ...
          <FaqCategory emoji="👕" title="Services & Garments">
            ...
            <FaqItem n={11} question="Can all types of clothes be cleaned?">
              <p>
                Most garments can be processed, but some delicate or restricted
                fabrics may not be accepted.
              </p>
            </FaqItem>
            <FaqItem n={12} question="Do you guarantee stain removal?">
              <p>
                While we use professional cleaning methods, we cannot guarantee
          ...
          <FaqCategory emoji="⚠️" title="Safety & Responsibility">
            ...
            >
              <p>
                In rare cases of damage or loss, you can raise a claim within
                the specified time. Compensation will be provided as per our
                policy.
              </p>
            </FaqItem>
          ...
          <FaqCategory emoji="📱" title="App & Account">
            ...
            <FaqItem n={17} question="How can I track my order?">
              <p>
                You can track your order status in real-time through the app.
              </p>
            </FaqItem>
          </FaqCategory>
          ...
          <FaqCategory emoji="📞" title="Support">
            <FaqItem n={18} question="How can I contact customer support?">
              ...
              <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                <a
                  ...
                  className="flex items-center gap-3 rounded-xl border border-[#E8DFD6] bg-white px-4 py-3 transition-colors hover:border-orange/40"
                >
            ...
            <FaqItem n={19} question="What if I have a complaint?">
              <p>
                You can contact our support team through the app or email. We
                aim to resolve all issues as quickly as possible.
              </p>
            </FaqItem>
          </FaqCategory>
        </div>
